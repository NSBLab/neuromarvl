    ...
    constructor() {
        ...
        */
        ...
        this.setEdgeDirectionGradient = () => {
            ...
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeDirectionGradient();
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeDirectionGradient();
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeDirectionGradient();
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeDirectionGradient();
        };
        this.setEdgeColorByWeight = () => {
            ...
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeColorByWeight(config);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeColorByWeight(config);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeColorByWeight(config);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeColorByWeight(config);
        };
        this.setEdgeColorByNode = () => {
            // save edge color setting
            this.saveFileObj.edgeSettings.colorBy = "node";
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeColorByNode();
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeColorByNode();
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeColorByNode();
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeColorByNode();
        };
        this.setEdgeNoColor = () => {
            // save edge color setting 
            this.saveFileObj.edgeSettings.colorBy = "none";
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeNoColor();
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeNoColor();
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeNoColor();
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeNoColor();
        };
        ...
        this.setNodeSizeOrColor = () => {
            ...
            if (sizeOrColor == "node-size") {
                ...
                if (this.applicationsInstances[0])
                    this.applicationsInstances[0].setNodeSize(newScaleArray);
                if (this.applicationsInstances[1])
                    this.applicationsInstances[1].setNodeSize(newScaleArray);
                if (this.applicationsInstances[2])
                    this.applicationsInstances[2].setNodeSize(newScaleArray);
                if (this.applicationsInstances[3])
                    this.applicationsInstances[3].setNodeSize(newScaleArray);
                ...
                if ((this.referenceDataSet.attributes.info[attribute] != null) && (this.referenceDataSet.attributes.info[attribute].isDiscrete && !nodeColorMode)) {
                    ...
                    if (this.applicationsInstances[0])
                        this.applicationsInstances[0].setNodeColorDiscrete(attribute, keyArray, colorArray);
                    if (this.applicationsInstances[1])
                        this.applicationsInstances[1].setNodeColorDiscrete(attribute, keyArray, colorArray);
                    if (this.applicationsInstances[2])
                        this.applicationsInstances[2].setNodeColorDiscrete(attribute, keyArray, colorArray);
                    if (this.applicationsInstances[3])
                        this.applicationsInstances[3].setNodeColorDiscrete(attribute, keyArray, colorArray);
                }
                else {
                    ...
                    let maxColor = "#000000";
                    if (this.applicationsInstances[0])
                        this.applicationsInstances[0].setNodeColor(attribute, minColor, maxColor);
                    if (this.applicationsInstances[1])
                        this.applicationsInstances[1].setNodeColor(attribute, minColor, maxColor);
                    if (this.applicationsInstances[2])
                        this.applicationsInstances[2].setNodeColor(attribute, minColor, maxColor);
                    if (this.applicationsInstances[3])
                        this.applicationsInstances[3].setNodeColor(attribute, minColor, maxColor);
                ...
                if (this.applicationsInstances[0])
                    this.applicationsInstances[0].setNodeDefaultSizeColor();
                if (this.applicationsInstances[1])
                    this.applicationsInstances[1].setNodeDefaultSizeColor();
                if (this.applicationsInstances[2])
                    this.applicationsInstances[2].setNodeDefaultSizeColor();
                if (this.applicationsInstances[3])
                    this.applicationsInstances[3].setNodeDefaultSizeColor();
                // Edge will also need updating if they are set to "node"
                if (this.commonData.edgeColorMode === "node") {
                    this.setEdgeColorByNode();
                }
        ...
        this.exportSVG = (viewport, fileType, resolution, filename, callback = null) => {
            ...
            requestAnimationFrame(() => {
                ...
                requestAnimationFrame(() => {
                    this.applicationsInstances[viewport].resize(this.applicationsInstances[viewport].jDiv.width(), this.applicationsInstances[viewport].jDiv.height());
                    if (prevsvgtransform != null)
        ...
        this.setEdgeDirection = () => {
            ...
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeDirection(value);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeDirection(value);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeDirection(value);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeDirection(value);
        };
        this.setEdgeColor = () => {
        ...
        this.setViewCrossroads = (x, y) => {
            ...
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].resize(lw, th);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].resize(rw, th);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].resize(lw, bh);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].resize(rw, bh);
        };
        ...
        */
        ...
        this.setBrainSurfaceColor = (color) => {
            ...
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setSurfaceColor(color);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setSurfaceColor(color);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setSurfaceColor(color);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setSurfaceColor(color);
        };
        this.setEdgeTransitionColor = (color) => {
            this.saveFileObj.edgeSettings.edgeColorByNodeTransitionColor = color;
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setEdgeTransitionColor(color);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setEdgeTransitionColor(color);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setEdgeTransitionColor(color);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setEdgeTransitionColor(color);
        };
        this.setUseTransitionColor = (useColor) => {
            this.saveFileObj.edgeSettings.edgeColorByNodeTransition = useColor;
            if (this.applicationsInstances[0])
                this.applicationsInstances[0].setUseTransitionColor(useColor);
            if (this.applicationsInstances[1])
                this.applicationsInstances[1].setUseTransitionColor(useColor);
            if (this.applicationsInstances[2])
                this.applicationsInstances[2].setUseTransitionColor(useColor);
            if (this.applicationsInstances[3])
                this.applicationsInstances[3].setUseTransitionColor(useColor);
        };
        ...
        */
        this.initListeners = () => {
            ...
            //    this.setNodeSizeOrColor();
            //});
            $("#input-surface-color").on('change', e => this.setBrainSurfaceColor(e.target.value));
