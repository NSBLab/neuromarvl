...
var DataSet = /** @class */ (function () {
    ...
    DataSet.prototype.clone = function () {
        ...
        // clone brain lables
        if (this.brainLabels)
            var newBrainLabels = this.brainLabels.slice(0);
        // clone attribute
    ...
    DataSet.prototype.getRecord = function (index) {
        ...
        if (this.brainLabels)
            record["label"] = this.brainLabels[index];
        record["id"] = index;
...
var SaveFile = /** @class */ (function () {
    function SaveFile(sourceObject) {
        ...
        if (sourceObject) {
            ...
            if (sourceObject.serverFileNameMatrix)
                this.serverFileNameMatrix = sourceObject.serverFileNameMatrix;
            if (sourceObject.serverFileNameAttr)
                this.serverFileNameAttr = sourceObject.serverFileNameAttr;
            if (sourceObject.serverFileNameLabel)
                this.serverFileNameLabel = sourceObject.serverFileNameLabel;
            if (sourceObject.filteredRecords)
